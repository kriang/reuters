...
class AgregarProductorHijos extends React.Component {
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div className="fondo">
                                    ...
                                    <div className="container-fluid">
                                        <div className="row">
                                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div className="desaparece div_exito"><i className="fa fa-check"></i> 5 parámetros agregados con éxito.</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-4 col-lg-push-4 col-md-4 col-sm-6 col-xs-12 text-center">
                                        <button type="button" data-toggle="modal" data-target="#myModal" className="text-center btn btn-primary m-t-md col-lg-12 col-md-12 col-sm-12 col-xs-12">¡LISTO!</button>
                                    </div>
...
export default AgregarProductorHijos;